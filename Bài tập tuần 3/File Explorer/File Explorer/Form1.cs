...
namespace File_Explorer
{
    public partial class File_Explorer : Form
    {
        ...
        {
            string currentDirectoryPath = Path.Text; // Đổi tên biến để tránh xung đột

            string newFolderName = "New Folder"; // Tên thư mục mới
            string newFolderPath = System.IO.Path.Combine(currentDirectoryPath, newFolderName); // Sử dụng Path.Combine

            int count = 1;

            // Kiểm tra xem tên thư mục đã tồn tại chưa
